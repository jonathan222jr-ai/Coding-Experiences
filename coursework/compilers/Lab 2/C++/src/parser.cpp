...
bool Parser::statement(void) {
  ...
  if( check_first_plus_set( current_word, FirstPlus::statement_p0 ) ) {
    ...
    if( (current_word.get_token_type() == TokenType::RESERVED_WORD) &&
        (current_word.get_token_name() == "if") ) {
    ...
    if( (current_word.get_token_type() == TokenType::RESERVED_WORD) &&
        (current_word.get_token_name() == "while") ) {
    ...
    if( (current_word.get_token_type() == TokenType::RESERVED_WORD) &&
        (current_word.get_token_name() == "break") ) {
    ...
    if( (current_word.get_token_type() == TokenType::RESERVED_WORD) &&
        (current_word.get_token_name() == "read") ) {
    ...
    if( (current_word.get_token_type() == TokenType::RESERVED_WORD) &&
        (current_word.get_token_name() == "write") ) {
    ...
    if( (current_word.get_token_type() == TokenType::RESERVED_WORD) &&
        (current_word.get_token_name() == "print") ) {
